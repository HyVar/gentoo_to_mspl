...
This can be done by running the following comamnd.
...
To compute a new configuration to install some packages the following command may be invoked.

```
bash hyportage.sh bash hyportage.sh emerge <packages to install>
```
...
Indded, running the following command  
```
...
TODO: Michael can you add few lines of explanation of conflict
...
* Test the incrementality of the translation process.
